                         ...
                         <div className="flex-1 overflow-y-auto space-y-4 custom-scrollbar pr-2">
                            <div className="flex items-center justify-between border-b border-zinc-900 pb-2">
                               <span className="text-[10px] text-zinc-600 font-black uppercase tracking-widest">
                                 {searchQuery.length > 1 ? `Search_Results: ${searchResults.length}` : `All_Registered_Personnel: ${allUsers.length - 1}`}
                               </span>
                            </div>
                            
                            {(searchQuery.length > 1 ? searchResults : allUsers).map(u => (
                              <div key={u.username} className="bg-zinc-900/50 border border-zinc-800 p-4 flex items-center justify-between group hover:border-blue-900 transition-all">
                                 <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex flex-col">
                                       <span className="text-xl font-black uppercase text-white tracking-tighter">
                                         {u.username} {u.username === currentUser && <span className="text-[10px] text-blue-500 font-bold ml-2">(YOU)</span>}
                                       </span>
                                 ...
                                 <div className="flex gap-2">
                                    ...
                                    {u.username === currentUser ? (
                                      <span className="px-6 py-2 bg-zinc-900 text-zinc-700 border border-zinc-800 font-bold uppercase text-[10px] italic">Self</span>
                                    ) : !currentUser ? (
