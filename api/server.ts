...
async function startServer() {
  ...
  const loadData = async () => {
    ...
    if (!users["blamer_508"]) {
      users["blamer_508"] = {
        username: "blamer_508",
        avatarUrl: "https://picsum.photos/seed/blamer/200/200",
        password: "password123",
        maxUnlockedNight: 7,
        highScores: { Easy: 0, Medium: 0, Hard: 0 }
      };
    }
    if (!users["ellieblockman"]) {
      users["ellieblockman"] = {
        username: "ellieblockman",
        avatarUrl: "https://picsum.photos/seed/ellie/200/200",
        password: "password123",
        description: "A developer for Fazbear's Tech Academy. He is responsible for the system's core architecture.",
        maxUnlockedNight: 7,
        highScores: { Easy: 0, Medium: 0, Hard: 0 }
      };
    }
        ...
        DEVS.forEach(dev => {
          if (dev !== profile.username) {
            ...
            if (!exists) {
              ...
              // Notify both if they are online
